                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex flex-col">
                                <div class="w-full">
                                 ...
                                 <!--===================-->
<!-- pagination 25, 200, 500, All was here. Now at pagination wall page-->
                                 <!-- ================= -->
                                 <!-- ${user.id} -->
                                                ...
                                                <tbody class="bg-white">
                                                    <tr v-for="user in Users.data" :key="user.id">
                                                        ...
                                                        <td v-if="user.id != $page.props.auth.user.id" class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                                                            <button @click.prevent="destroy('destroy.user', {id: user.id})" class="rounded-lg bg-red-500 px-2 py-2 h-8 text-white text-xs hover:bg-red-700">
                                                                Delete
                                                            </button>
                                                        </td>
                                                  <!-- =====Status==== -->
                                                        <td v-if="user.email != $page.props.auth.user.id" class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                                                            <button @click.prevent="deactivate(`${user.id}`)" class="rounded-lg bg-blue-500 px-2 py-2 h-8 text-white text-xs hover:bg-red-700">
                                                                Deactivate
                                                            </button>
                                                        </td>
...
export default {
   ...
   methods: {
    ...
    const response = await axios.get(`/api/your-endpoint`, { params: query });
